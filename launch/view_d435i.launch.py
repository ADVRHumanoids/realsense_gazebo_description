...
def generate_launch_description():
    ...
    xacro_path = os.path.join(get_package_share_directory('realsense_gazebo_description'), 'urdf', 'd435i_standalone.urdf.xacro')
    ...
    world_tf_pub = Node (
        ...
        arguments=[
            "--frame-id", "world",
            "--child-frame-id", "D435i_camera_bottom_screw_frame",
